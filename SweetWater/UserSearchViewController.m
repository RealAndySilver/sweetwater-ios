...
@synthesize esExpress;
- (void)viewDidLoad
{
    [super viewDidLoad];
    [self setTitle:@"Editar Cliente"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    int index=0;
    if (segmentedControl.selectedSegmentIndex==0){
        index=[arrayNombres indexOfObject:cell.textLabel.text];
    }
    else if (segmentedControl.selectedSegmentIndex==1){
        index=[arrayTelefonos indexOfObject:cell.textLabel.text];
    }
    else if (segmentedControl.selectedSegmentIndex==2){
        index=[arrayIndicaciones indexOfObject:cell.textLabel.text];
    }
    else if (segmentedControl.selectedSegmentIndex==3){
        index=[arrayDirecciones indexOfObject:cell.textLabel.text];
    }
    ...
    euVC.userDictionary=usersArray[index];
    [self.navigationController pushViewController:euVC animated:YES];
...
//                index=[arrayDirecciones indexOfObject:cell.textLabel.text];
//            }
//            [self removeUser:usersArray[index]];
//            [tableview beginUpdates];
//            NSMutableArray *array=[[NSMutableArray alloc]initWithArray:usersArray];
